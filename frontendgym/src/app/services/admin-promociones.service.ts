...
import { environment } from '../../environments/environment'; // 👈 verifica la ruta

@Injectable({ providedIn: 'root' })
export class AdminPromocionesService {

  // Antes: private base = '/api/promociones';
  private base = `${environment.apiBaseUrl}/api/promociones`;
